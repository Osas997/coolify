    ...
    <x-layout>
        ...
        <form action="{{ route('kerjasama.update', $kerjasama->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama" name="nama_instansi" value="{{ $kerjasama->nama_instansi }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

            <div class="mb-4">
                <label for="image" class="block text-gray-700">Gambar:</label>
                <input type="file" id="image" name="gambar" value="{{ $kerjasama->gambar }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <img src="{{ asset('storage/upload/kerjasama/' . $kerjasama->gambar) }}" alt="Produk Image"
