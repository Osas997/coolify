        ...
        <form action="{{ route('Artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="w-full" style="display: none;">
                ...
                <input type="hidden" name="tgl_published" id="tgl_published"
                    value="{{ old('tgl_published', $artikel->tgl_published) }}">
            </div>
            <div class="mb-4">
                ...
                <img src="{{ asset('storage/upload/artikel/' . $artikel->gambar) }}" alt="Artikel Image"
                    class="mt-2 w-[300px]" width="450" height="450">
            </div>
