<x-app-layout>
    <x-layout>
        ...
        <h3 class="text-3xl font-bold dark:text-white px-4 lg:px-12">Daftar Artikel</h3>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3" style="display: none;">
                                ...
                                {{ \Carbon\Carbon::parse($artikel->tgl_published)->locale('id')->isoFormat('dddd, D MMMM
                                YYYY') }}
                            </td>
                            <td class="px-4 py-3" style="display: none;">
                                <input type="hidden" name="nama_published" value="{{ $artikel->nama_published }}">
                                {{ $artikel->nama_published }}
                            </td>
